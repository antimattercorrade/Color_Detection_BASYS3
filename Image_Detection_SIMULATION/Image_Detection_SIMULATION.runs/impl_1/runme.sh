...
HD_PWD='C:/Users/Kushagra Sharma/Downloads/Digital Systems/Image_Detection_SIMULATION/Image_Detection_SIMULATION.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Color_Detection.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Color_Detection.tcl -notrace
