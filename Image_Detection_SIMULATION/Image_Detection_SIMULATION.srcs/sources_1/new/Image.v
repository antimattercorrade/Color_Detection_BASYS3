...
module Color_Detection(clock,switch_input,count,red,blue,green,yellow,aqua,fuchsia,lime,maroon,navy,olive,purple,silver,teal,
    ...
    output reg [3:0] yellow=0;
    output reg [3:0] maroon=0;
    output reg [3:0] silver=0;
    output reg [3:0] teal=0;
    output reg [3:0] lime=0;
    output reg [3:0] olive=0;
    output reg [3:0] fuchsia=0;
    output reg [3:0] navy=0;
    output reg [3:0] purple=0;
